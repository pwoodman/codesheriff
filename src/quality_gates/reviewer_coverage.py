...
ITEMS: tuple[CoverageItem, ...] = (
    ...
    CoverageItem(58, "OpenAI-Compatible Endpoint Support", "OPENAI_BASE_URL"),
    CoverageItem(59, "Local/Self-Hosted Option", "CLI + `codesheriff serve`"),
    CoverageItem(
        60, "VPC/Private-Network Execution", "self-hosted runners + offline mode"
    ),
    CoverageItem(61, "Secrets Redaction", "redact_secrets"),
    CoverageItem(62, "Audit Logs", "audit.jsonl"),
    CoverageItem(63, "RBAC", "map_github_role"),
    CoverageItem(64, "SSO/SAML and SCIM", "app_identity.sso/scim"),
    CoverageItem(65, "Security-Policy Packs", "owasp-asvs + cwe-top-25"),
    CoverageItem(66, "Compliance Evidence Export", "export_evidence"),
    CoverageItem(67, "Vulnerability Verification", "reachability via impact/index"),
    CoverageItem(68, "Static Analysis Integration", "ingest_sarif"),
    CoverageItem(69, "Finding Deduplication", "dedupe_findings"),
    CoverageItem(70, "Baseline Management", "observe/adopt/enforce"),
    CoverageItem(71, "Custom Rule Authoring", ".quality/rules markdown"),
    CoverageItem(72, "Rule Simulation", "simulate_rule"),
    CoverageItem(73, "Review Analytics", "cost/history + feedback"),
    CoverageItem(74, "Signal-Quality Analytics", "reviewbench + feedback"),
    CoverageItem(75, "Per-Rule Performance", "rule_stats"),
    CoverageItem(76, "Cost Dashboard", "cost.json"),
    CoverageItem(77, "Cost Budgets and Caps", "within_budget"),
    CoverageItem(78, "Pricing Aligned to Value", "app_identity.pricing"),
    CoverageItem(79, "Change-Impact Map", "impact_map"),
    CoverageItem(80, "API Contract Review", "contract gate"),
    CoverageItem(81, "Database Migration Review", "migration pack + advanced gate"),
    CoverageItem(82, "Performance Review", "performance pack"),
    CoverageItem(83, "Concurrency Review", "concurrency pack + regex"),
    CoverageItem(84, "Error-Handling Review", "error-handling pack + regex"),
    CoverageItem(85, "Accessibility Review", "accessibility pack"),
    CoverageItem(86, "Documentation Drift Detection", "docs_drift"),
    CoverageItem(87, "Release-Note Draft", "notes.draft_notes"),
    CoverageItem(88, "Issue Linkage Awareness", "linked_issues"),
    CoverageItem(89, "Architecture Decision Awareness", "load_adrs"),
    CoverageItem(90, "Historical Code-Review Awareness", "similar_history"),
    CoverageItem(91, "Learning from Dispositions", "apply_feedback non-security"),
    CoverageItem(92, "Reviewer Workload Routing", "suggest_reviewers"),
    CoverageItem(93, "Slack/Teams Notifications", "notify_chat"),
    CoverageItem(94, "Public API", "codesheriff serve"),
    CoverageItem(95, "Webhooks for Outcomes", "emit_outcome"),
    CoverageItem(96, "Open-Source Core/SDK", "MIT + quality.schema.json + packs"),
    CoverageItem(
        97, "Transparent Evaluation Suite", "codesheriff eval + standards/EVAL.md"
    ),
)
